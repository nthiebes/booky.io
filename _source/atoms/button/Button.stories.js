    ...
    'Small', {
      chapters: [{
        ...
        sections: [{
          ...
          title: 'Disabled',
          sectionFn: () => (<ButtonSmallPrimary disabled>{ 'Button text' }</ButtonSmallPrimary>)
        }, {
          title: 'Disabled with icon',
          sectionFn: () => (<ButtonSmallPrimary icon="heart" disabled>{ 'Button text' }</ButtonSmallPrimary>)
        }]
      }, {
        title: 'Light',
        sections: [{
          ...
          title: 'Disabled',
          sectionFn: () => (<ButtonSmallLight disabled>{ 'Button text' }</ButtonSmallLight>)
        }, {
          title: 'Disabled with icon',
          sectionFn: () => (<ButtonSmallLight icon="heart" disabled>{ 'Button text' }</ButtonSmallLight>)
        }]
      }, {
        title: 'Medium',
        sections: [{
          ...
          title: 'Disabled',
          sectionFn: () => (<ButtonSmallMedium disabled>{ 'Button text' }</ButtonSmallMedium>)
        }, {
          title: 'Disabled with icon',
          sectionFn: () => (<ButtonSmallMedium icon="heart" disabled>{ 'Button text' }</ButtonSmallMedium>)
        }]
      }, {
        title: 'Dark',
        sections: [{
          ...
          title: 'Disabled',
          sectionFn: () => (<ButtonSmallDark disabled>{ 'Button text' }</ButtonSmallDark>)
        }, {
          title: 'Disabled with icon',
          sectionFn: () => (<ButtonSmallDark icon="heart" disabled>{ 'Button text' }</ButtonSmallDark>)
        }]
      }]
    }
  );
