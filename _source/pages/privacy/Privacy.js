    ...
    return (
      <Page>
        <Section>
          ...
          <P>{ 'This policy is powered by Free Privacy Policy and Rhino Support ' }<Link target="_blank" href="https://www.rhinosupport.com/">{ 'help desk software' }</Link>{ '.' }</P>
        </Section>
      </Page>
    );
  }
