        ...
        <Section>
          {locale === 'en' && (
            <Fragment>
              ...
              <P>
                Our IT systems automatically record other data when you visit
                our website. This data comprises primarily technical information
              ...
              <P>
                ...
                eradicated. Please do not hesitate to contact us at any time
                under the address disclosed in section „Information Required by
                Law“ on this website if you have questions about this or any
                other data protection related issues. You also have the right to
              ...
              <P>
                ...
                For details, please consult the Data Protection Declaration
              ...
              <P>
                ...
                statistically analysed when your visit this website. Such
                analyses are performed primarily with cookies and with what we
                refer to as analysis programmes. As a rule, the analyses of your
                browsing patterns are conducted anonymously; i.e. the browsing
                patterns cannot be traced back to you.
              </P>
              <P>
                You have the option to object to such analyses or you can
                prevent their performance by not using certain tools. For
                detailed information about the tools and about your options to
              ...
              <P>
                ...
                Personal data collected on this website are stored on the
                servers of the host. These may include, but are not limited to,
                IP addresses, contact requests, metadata and communications,
                contract information, contact information, names, web page
              ...
              <P>
                ...
                DSGVO) and in the interest of secure, fast and efficient
              ...
              <P>
                ...
                fulfil its performance obligations and to follow our
                instructions with respect to such data.
              </P>

              <H3>Cloudflare</H3>
              <P>
                We use the “Cloudflare” service provided by Cloudflare, Inc. 665
                3rd St. #200, San Francisco, CA 94107, USA. (hereinafter
              ...
              <P>
                ...
                occurs between your browser and our website is technically
                routed via Cloudflare’s network. This enables Cloudflare to
                analyze data transactions between your browser and our website
                and to work as a filter between our servers and potentially
                malicious data traffic from the Internet. In conjunction with
                this, Cloudflare may also use cookies. However, these cookies
                will only be used for the purpose described herein.{' '}
              </P>
              <P>
                We have executed a contract processing agreement with
                Cloudflare. Cloudflare is also a certified participant of the
                “EU-US Privacy Shield Framework.” Cloudflare has undertaken to
                handle all personal data originating from the member states of
                the European Union (EU) in compliance with the “Privacy Shield
                Framework.”
              </P>
              <P>
                ...
                secure as possible (Art. 6 Sect. 1 lit. f GDPR).
              </P>
              <P>
                For more information on Cloudflare’s security precautions and
              ...
              <P>
                In order to guarantee processing in compliance with data
                protection regulations, we have concluded an order processing
                contract with our host.
              </P>
              ...
              <P>
                E-mail:{' '}
                <Link href="mailto:privacy@booky.io">{'privacy@booky.io'}</Link>
              </P>
              <P>
              ...
              <P>
                ...
                SECT. 1 LIT. E OR F GDPR, YOU HAVE THE RIGHT TO AT ANY TIME
                OBJECT TO THE PROCESSING OF YOUR PERSONAL DATA BASED ON GROUNDS
                ARISING FROM YOUR UNIQUE SITUATION. THIS ALSO APPLIES TO ANY
                PROFILING BASED ON THESE PROVISIONS. TO DETERMINE THE LEGAL
                BASIS, ON WHICH ANY PROCESSING OF DATA IS BASED, PLEASE CONSULT
                THIS DATA PROTECTION DECLARATION. IF YOU LOG AN OBJECTION, WE
                WILL NO LONGER PROCESS YOUR AFFECTED PERSONAL DATA, UNLESS WE
                ARE IN A POSITION TO PRESENT COMPELLING PROTECTION WORTHY
                GROUNDS FOR THE PROCESSING OF YOUR DATA, THAT OUTWEIGH YOUR
                INTERESTS, RIGHTS AND FREEDOMS OR IF THE PURPOSE OF THE
              ...
              <P>
                ...
                an SSL or a TLS encryption programme. You can recognise an
              ...
              <P>
                ...
                have the right to at any time demand information about your
                archived personal data, their source and recipients as well as
                the purpose of the processing of your data. You may also have a
              ...
              <P>
                ...
                “cookies.” Cookies are small text tiles that do not cause any
                damage to your device. They are either stored temporarily for
                the duration of a session (session cookies) or they are
                ...
                Permanent cookies remain archived on your device until you
                actively delete them or they are automatically eradicated by
                your web browser.
              </P>
              ...
              <P>
                ...
                work in the absence of the cookies (e.g. the shopping cart
                function or the display of videos). The purpose of other cookies
                may be the analysis of user patterns or the display of
                promotional messages.
              </P>
              <P>
                Technically essential cookies (e.g. shopping cart cookies) are
                archived on the basis of Art. 6 Sect. 1 lit. f GDPR. We have a
                legitimate interest in in storing these cookies to ensure the
                technically error-free and optimized delivery of our services.
                Other cookies are stored only subject to your consent on the
                basis of Art. 6 Sect. 1 lit. a GDPR. You do have the right to
                revoke such consent at any time, which will affect all future
                data transactions.
              </P>
              <P>
              ...
              <P>
                ...
                GDPR, if your request is related to the execution of a contract
                or if it is necessary to carry out pre-contractual measures. In
                all other cases the processing is based on our legitimate
                interest in the effective processing of the requests addressed
                to us (Art. 6 Para. 1 lit. f DSGVO) or on your agreement (Art. 6
                Para. 1 lit. a DSGVO) if this has been requested.
              </P>
              <P>
                ...
                shall be without prejudice to any mandatory legal provisions –
                in particular retention periods.
              </P>

              <H3>Request by e-mail</H3>
              <P>
                If you contact us by e-mail, your request, including all
              ...
              <P>
                ...
                GDPR, if your request is related to the execution of a contract
                or if it is necessary to carry out pre-contractual measures. In
                all other cases, the processing is based on your consent
                (Article 6 (1) a GDPR) and/or on our legitimate interests
                (Article 6 (1) (f) GDPR), since we have a legitimate interest in
              ...
              <P>
                ...
                process on the basis of your consent (Art. 6 Sect. 1 lit. a
                GDPR).
              </P>
              <P>
              ...
              <P>
                ...
                which are stored on your computer and that enable an analysis of
                the use of the website by users. The information generated by
                cookies on your use of this website is usually transferred to a
                Google server in the United States, where it is stored.
              </P>
              <P>
                The storage of Google Analytics cookies and the utilization of
                this analysis tool are based on Art. 6 Sect. 1 lit. f GDPR. The
                operator of this website has a legitimate interest in the
                analysis of user patterns to optimize both, the services offered
                online and the operator’s advertising activities. If a
                corresponding agreement has been requested (e.g. an agreement to
                the storage of cookies), the processing takes place exclusively
              ...
              <P>
                ...
                function. As a result, your IP address will be abbreviated by
                Google within the member states of the European Union or in
                other states that have ratified the Convention on the European
                Economic Area prior to its transmission to the United States.
                The full IP address will be transmitted to one of Google’s
                servers in the United States and abbreviated there only in
                exceptional cases. On behalf of the operator of this website,
                Google shall use this information to analyse your use of this
                website to generate reports on website activities and to render
                other services to the operator of this website that are related
                to the use of the website and the Internet. The IP address
                transmitted in conjunction with Google Analytics from your
              ...
              <P>
                ...
                making pertinent changes to the settings of your browser
                software. However, we have to point out that in this case you
                may not be able to use all of the functions of this website to
                their fullest extent. Moreover, you have the option prevent the
                recording of the data generated by the cookie and affiliated
                with your use of the website (including your IP address) by
                Google as well as the processing of this data by Google by
              ...
              <P>
                ...
                Google Analytics by clicking on the following link. This will
                result in the placement of an opt out cookie, which prevents the
                recording of your data during future visits to this website:{' '}
                <Link role="button" href="#" onClick={this.handleClick}>
          ...
          {locale === 'de' && (
            <Fragment>
              ...
              <P>
                ...
                Cloudflare, Inc. 665 3rd St. #200, San Francisco, CA 94107, USA
              ...
              <P>
                ...
                Informationstransfer zwischen Ihrem Browser und unserer Webseite
                über das Netzwerk von Cloudflare geleitet. Das versetzt
                Cloudflare in die Lage, den Datenverkehr zwischen Ihrem Browser
                und unserer Webseite zu analysieren und als Filter zwischen
                unseren Servern und potenziell bösartigem Datenverkehr aus dem
                Internet zu dienen. Hierbei kann Cloudflare auch Cookies
                einsetzen, die jedoch allein zum hier beschriebenen Zweck
                eingesetzt werden.
              </P>
              <P>
                Wir haben mit Cloudflare einen Vertrag über Auftragsverarbeitung
                abgeschlossen. Cloudflare ist zudem zertifizierter Teilnehmer
                des „EU-US Privacy Shield Frameworks“. Cloudflare hat sich dazu
                verpflichtet, sämtliche aus den Mitgliedstaaten der Europäischen
                Union (EU) erhaltenen personenbezogenen Daten gemäß dem „Privacy
              ...
              <P>
                ...
                Nutzerverhalten zu auszuwerten oder Werbung anzuzeigen.
              </P>
              <P>
                ...
                Dienste. Andere Cookies werden nur mit Ihrer Einwilligung auf
                Grundlage von Art. 6 Abs. 1 lit. a DSGVO gespeichert. Die
              ...
              <P>
                ...
                begründeten Nutzungsverhältnisses und ggf. zur Anbahnung
              ...
              <P>
                ...
                werden nach 14 Monaten anonymisiert bzw. gelöscht. Details
